...
<table class="table table-striped">
    ...
    <tbody>
        ...
        $nomor = $mulai + 1;
        $sql1 = $sql1 . " ORDER BY id DESC LIMIT $mulai,$perinfo";
        ...
        ?>
            <tr>
                ...
                <td>
                    ...
                    <a href="info.php?op=delete&id=<?php echo $r1['id'] ?>" onclick="return confirm('Apakah Yakin Menghapus Data?')">
...
<nav aria-label="Page Navigation Example" class="nav justify-content-center">
    <ul class="pagination">
        ...
        ?>
            <li class="page-item">
                <a href="info.php?katakunci=<?php echo $katakunci ?>&cari=<?php echo $cari ?>&page=<?php echo $i ?>" class="page-link"><?php echo $i ?></a>
            </li>
        <?php
        }
        ?>
