        ...
        ?>
            <tr>
                ...
                <td>
                    ...
                    <a href="tutors.php?op=delete&id=<?php echo $r1['id'] ?>" onclick="return confirm('Apakah Yakin Menghapus Data?')">
...
<nav aria-label="Page Navigation Example" class="nav justify-content-center">
    <ul class="pagination">
        ...
        ?>
            <li class="page-item">
                <a href="tutors.php?katakunci=<?php echo $katakunci ?>&cari=<?php echo $cari ?>&page=<?php echo $i ?>" class="page-link"><?php echo $i ?></a>
            </li>
        <?php
        }
        ?>
